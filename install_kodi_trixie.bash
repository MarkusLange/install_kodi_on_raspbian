...
#install/modity Kodi all this injections need a restart of the service kodi to get this to take action
...
#debugview
#sudo sed -i "/debugging/ s/false/true/" /usr/share/kodi/addons/skin.estuary/addon.xml
